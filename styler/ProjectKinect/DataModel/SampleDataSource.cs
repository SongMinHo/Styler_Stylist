...
namespace Microsoft.Samples.Kinect.ControlsBasics.DataModel
{
    ...
    public class SampleDataSource
    {
        ...
        SampleDataCollection dataGroup; // var dataGroup
        ...
        private IList<ImageSource> imgList;
        private IList<ImageTrack> imgTrack;
        ...
        public SampleDataCollection GetGroup()
        {
            // Simple linear search is acceptable for small data sets
            return dataGroup;
        }

        public IList<int> GetValueGroup()
        {
            return values;
        }
    }
    ...
    public abstract class SampleDataCommon : BindableBase
    {
        ...
        protected SampleDataCommon(string uniqueId, string title, string subtitle, ImageSource imageSource, string description)
        {
    ...
    public class SampleDataCollection : SampleDataCommon, IEnumerable
    {
        ...
        public SampleDataCollection(string uniqueId, string title, string subtitle, ImageSource imageSource, string description)
            : base(uniqueId, title, subtitle, imageSource, description)
        {
